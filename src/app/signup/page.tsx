...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen w-screen flex bg-white transition-colors duration-200 select-none overflow-hidden font-sans">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12">
        <div className="max-w-md w-full mx-auto space-y-7">
          ...
          <form onSubmit={handleSignup} className="space-y-5 pt-2">
            ...
            {/* Full Name */}
            <div className="flex flex-col border-b border-slate-200 py-1.5 focus-within:border-[#96cdfb] transition-all">
              <label className="text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">
                Full name
              </label>
              <input
                type="text"
                ...
                disabled={loading}
                className="w-full bg-transparent border-none p-0 text-sm text-slate-800 placeholder-slate-300 focus:outline-hidden focus:ring-0 focus:border-none"
              />
            </div>
            ...
            <div className="flex items-center gap-2.5 pt-2 select-none">
              ...
              />
              <label htmlFor="agreeTerms" className="text-xs text-slate-400 font-medium cursor-pointer">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#faf9f6] relative">
        <Image
          src={illustration}
